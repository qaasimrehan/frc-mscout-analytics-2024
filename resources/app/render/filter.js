...
var filterMatchesOnClick = () => {
    ...
    if ($("#filterStartDate").calendar("get date") != null) {
        if (filterMatchesObj.timeStamp == undefined) {
            filterMatchesObj.timeStamp = {};
        }
    ...
    var mtArr = [];
    if ($("#filterTest").checkbox("is checked")) {
        mtArr.push("T");
    }
    if ($("#filterPracticeField").checkbox("is checked")) {
        mtArr.push("PF");
    }
    if ($("#filterPracticeMatch").checkbox("is checked")) {
        mtArr.push("PM");
    }
    if ($("#filterQualification").checkbox("is checked")) {
        mtArr.push("Q");
    }
    if ($("#filterQuarterfinals").checkbox("is checked")) {
        mtArr.push("QF");
    }
    if ($("#filterSemifinals").checkbox("is checked")) {
        mtArr.push("SF");
    }
    if ($("#filterFinals").checkbox("is checked")) {
        mtArr.push("F");
    }
    if ($("#filterNoTBA").checkbox("is checked")) {
        filterMatchesObj.tbaData = null;
    }
    if ($("#filterOnlyTBA").checkbox("is checked")) {
        filterMatchesObj.tbaData = {$ne: null};
    }
    if (mtArr.length > 0) {
        filterMatchesObj.matchType = {$in: mtArr};
    }
    if (document.getElementById("filterTeamDropdown") != null) {
        ...
        if ($("#filterTeamDropdown").dropdown("get value") != "") {
            filterMatchesObj.targetTeam = {$in: tArr};
        }
    }
}

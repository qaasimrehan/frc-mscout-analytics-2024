    ...
    ipcRenderer.once("query-reply", (event, docs) => {
        ...
        table = new Tabulator("#dataTable", {
            ...
            columns: [
                ...
                {title: "Auto Grid Lvl 1 Cone", field: "counts.S_C_R1"},
                {title: "Auto Failed Grid Lvl 1 Cone", field: "counts.S_FC_R1"},
                {title: "Auto Grid Lvl 2 Cube", field: "counts.S_H_R2"},
                {title: "Auto Failed Grid Lvl 2 Cube", field: "counts.S_FH_R2"},
                {title: "Auto Grid Lvl 2 Cone", field: "counts.S_C_R2"},
                {title: "Auto Failed Grid Lvl 2 Cone", field: "counts.S_FC_R2"},
                {title: "Auto Grid Lvl 3 Cube", field: "counts.S_H_R3"},
                {title: "Auto Failed Grid Lvl 3 Cube", field: "counts.S_FH_R3"},
                {title: "Auto Grid Lvl 3 Cone", field: "counts.S_C_R3"},
                {title: "Auto Failed Grid Lvl 3 Cone", field: "counts.S_FC_R3"},
                {title: "Grid Lvl 1 Cube", field: "counts.NS_H_R1"},
                {title: "Failed Grid Lvl 1 Cube", field: "counts.NS_FH_R1"},
                {title: "Grid Lvl 1 Cone", field: "counts.NS_C_R1"},
                {title: "Failed Grid Lvl 1 Cone", field: "counts.NS_FC_R1"},
                {title: "Grid Lvl 2 Cube", field: "counts.NS_H_R2"},
                {title: "Failed Grid Lvl 2 Cube", field: "counts.NS_FH_R2"},
                {title: "Grid Lvl 2 Cone", field: "counts.NS_C_R2"},
                ...
                {title: "Crossed Over Ramp", field: "counts.FC"}
            ],
            pagination: "local",
            paginationSize: 12
        });
